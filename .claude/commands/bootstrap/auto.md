---
description: â¡â¡â¡â¡ Bootstrap a new project automatically
...
1. Use `planner` subagent and multiple `researcher` subagents in parallel to find a best fit tech stack for this project, keeping research reports within the â¤150 lines limit.
...
- Keep related research reports within the â¤150 lines limit.
