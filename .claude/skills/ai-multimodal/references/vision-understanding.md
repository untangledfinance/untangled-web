...
**Large images**: Tiled into 768Ã768 chunks, 258 tokens each

**Formula**:

```
crop_unit = floor(min(width, height) / 1.5)
tiles = (width / crop_unit) Ã (height / crop_unit)
total_tokens = tiles Ã 258
```

**Examples**:

- 256Ã256: 258 tokens (small)
- 512Ã512: 258 tokens (small)
- 960Ã540: 6 tiles = 1,548 tokens
- 1920Ã1080: 6 tiles = 1,548 tokens
- 3840Ã2160 (4K): 24 tiles = 6,192 tokens
