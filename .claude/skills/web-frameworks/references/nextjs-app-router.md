...
```
app/
âââ (marketing)/          # Group without URL segment
...
```
app/
âââ @team/               # Named slot
â   âââ page.tsx
âââ @analytics/          # Named slot
â   âââ page.tsx
âââ page.tsx             # Default children
âââ layout.tsx           # Consumes slots
```
...
âââ (..)photo/            # Intercepts /photo/[id]
    âââ [id]/
        âââ page.tsx      # Modal photo view
```
...
```
app/
âââ (auth)/                 # Route group for auth pages
â   âââ login/
â   âââ signup/
...
â   âââ auth/
â   âââ posts/
âââ _components/           # Private folder (not routes)
â   âââ header.tsx
â   âââ footer.tsx
âââ _lib/                  # Private utilities
â   âââ auth.ts
â   âââ db.ts
âââ layout.tsx             # Root layout
