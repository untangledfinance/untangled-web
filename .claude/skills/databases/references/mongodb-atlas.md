...
```javascript
// Via Atlas UI: Database â Add Database
// Via shell
use myNewDatabase
...
```javascript
// IP Whitelist (Atlas UI â Network Access)
...
```javascript
// Create via Atlas UI â Database Access
...
// 1. Clusters â cluster name â Backup tab
...
```javascript
// Configure via Atlas UI â Alerts
// Alert types:
...
// Atlas UI â Performance Advisor
...
```javascript
// Atlas UI â Search â Create Index
...
```javascript
// Atlas UI â Charts â New Dashboard
...
// â Add IP to Network Access

// Authentication failed: wrong credentials
// â Verify username/password in Database Access

// Timeout: connection string or network issue
// â Check connection string format, DNS resolution
```
