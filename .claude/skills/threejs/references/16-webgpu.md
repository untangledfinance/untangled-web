...
import { Fn, storageBuffer, uniform } from 'three/nodes';
...
```javascript
import { Fn, float, storage, vec3 } from 'three/nodes';
...
```javascript
import { MeshStandardNodeMaterial, normalMap, texture } from 'three/nodes';
