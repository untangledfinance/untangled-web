...
```javascript
import { Fn, float, vec3 } from 'three/nodes';
...
```javascript
import { oscSine, timerLocal, uniform } from 'three/nodes';
...
```javascript
import { dot, normalView, positionView, pow } from 'three/nodes';
...
```javascript
import { normalLocal, positionLocal, sin, timerLocal } from 'three/nodes';
...
```javascript
import { TBNViewMatrix, normalMap, normalView } from 'three/nodes';
...
```javascript
import { Fn, compute, storage, uniform } from 'three/nodes';
...
```javascript
import { PassNode, pass } from 'three/nodes';
