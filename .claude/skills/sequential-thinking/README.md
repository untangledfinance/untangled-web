...
â
âââ scripts/
â   âââ process-thought.js (executable)
...
â
âââ tests/
â   âââ process-thought.test.js
...
â
âââ references/
    âââ core-patterns.md (95 lines)
    â   Essential revision & branching patterns
    â
    âââ examples-api.md (88 lines)
    â   API design example walkthrough
    â
    âââ examples-debug.md (90 lines)
    â   Performance debugging example
    â
    âââ examples-architecture.md (94 lines)
    â   Architecture decision example
    â
    âââ advanced-techniques.md (76 lines)
