...
âââ scripts/
â   âââ mcp-client.ts          # Core MCP client manager
â   âââ analyze-tools.ts       # Intelligent tool selection
â   âââ cli.ts                 # Command-line interface
â   âââ package.json           # Dependencies
â   âââ tsconfig.json          # TypeScript config
â   âââ .env.example           # Environment template
âââ references/
    âââ mcp-protocol.md        # MCP protocol reference
