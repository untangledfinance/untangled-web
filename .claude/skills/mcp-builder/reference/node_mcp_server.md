...
âââ README.md
âââ src/
â   âââ index.ts          # Main entry point with McpServer initialization
â   âââ types.ts          # TypeScript type definitions and interfaces
â   âââ tools/            # Tool implementations (one file per domain)
â   âââ services/         # API clients and shared utilities
