...
echo "ð Installing system dependencies for Chrome/Chromium..."
echo ""
...
if [ -f /etc/os-release ]; then
    ...
    echo "â Cannot detect OS. This script supports Debian/Ubuntu-based systems."
    exit 1
fi
...
if [ "$EUID" -ne 0 ]; then
    SUDO="sudo"
    echo "â ï¸  This script requires root privileges to install system packages."
...
case $OS in
    ubuntu|debian|pop)
        ...
        echo ""
        echo "â System dependencies installed successfully!"
        ;;
