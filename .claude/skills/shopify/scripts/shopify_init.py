...
"""
    ...
    def init_app(self) -> None:
        ...
        print(f"â Created package.json")

        print(f"\nâ App '{app_name}' initialized successfully!")
        print(f"\nNext steps:")
        print(f"  cd {app_name}")
        print(f"  npm install")
    ...
    def init_extension(self) -> None:
        ...
        print(f"\nâ Extension '{extension_name}' initialized successfully!")
        print(f"\nNext steps:")
