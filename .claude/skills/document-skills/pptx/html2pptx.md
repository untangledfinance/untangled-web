...
- â Correct: `<div><p>Text here</p></div>`
- â Wrong: `<div>Text here</div>` - **Text will NOT appear in PowerPoint**
- â Wrong: `<span>Text</span>` - **Text will NOT appear in PowerPoint**
...
- â Web-safe fonts: `Arial`, `Helvetica`, `Times New Roman`, `Georgia`, `Courier New`, `Verdana`, `Tahoma`, `Trebuchet MS`, `Impact`, `Comic Sans MS`
- â Wrong: `'Segoe UI'`, `'SF Pro'`, `'Roboto'`, custom fonts - **Might cause rendering issues**
...
- â Correct: `color: "FF0000"`, `fill: { color: "0066CC" }`
- â Wrong: `color: "#FF0000"` (breaks document)
