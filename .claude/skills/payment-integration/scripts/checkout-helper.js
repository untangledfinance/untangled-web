...
class CheckoutHelper {
  ...
  static generatePolarCheckout(config) {
    ...
    if (externalCustomerId)
      checkoutConfig.external_customer_id = externalCustomerId;
    ...
    return {
      ...
      curlCommand: this.generatePolarCurl(
        checkoutConfig,
        config.accessToken,
        config.server
      ),
...
if (require.main === module) {
  ...
  try {
    ...
    if (platform === 'sepay') {
      ...
      console.log('â SePay Checkout Generated\n');
      ...
      if (!config.accessToken) {
        console.error('â Error: POLAR_ACCESS_TOKEN is required');
      ...
      console.log('â Polar Checkout Configuration Generated\n');
      ...
      console.error(`â Error: Unknown platform '${platform}'`);
