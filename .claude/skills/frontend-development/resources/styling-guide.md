...
// â CORRECT - v7 syntax with size prop
...
### â makeStyles (MUI v4 pattern)

```typescript
// â AVOID - Old Material-UI v4 pattern
...
```typescript
// â AVOID - styled-components pattern
...
- â Use `sx` prop for MUI styling
- â Type-safe with `SxProps<Theme>`
- â <100 lines: inline; >100 lines: separate file
- â MUI v7 Grid: `size={{ xs: 12 }}`
- â 4 space indentation
- â Single quotes
- â Trailing commas
- â No makeStyles or styled()
