...
def init_skill(skill_name, path):
    ...
    if skill_dir.exists():
        print(f"â Error: Skill directory already exists: {skill_dir}")
        return None

    # Create skill directory
    try:
        skill_dir.mkdir(parents=True, exist_ok=False)
        print(f"â Created skill directory: {skill_dir}")
    except Exception as e:
        print(f"â Error creating directory: {e}")
        return None
    ...
    try:
        ...
        print("â Created SKILL.md")
    except Exception as e:
        print(f"â Error creating SKILL.md: {e}")
        return None
    ...
    try:
        ...
        print("â Created scripts/example.py")
        ...
        print("â Created references/api_reference.md")
        ...
        print("â Created assets/example_asset.txt")
    except Exception as e:
        print(f"â Error creating resource directories: {e}")
        return None

    # Print next steps
    print(f"\nâ Skill '{skill_name}' initialized successfully at {skill_dir}")
    print("\nNext steps:")
...
def main():
    ...
    print(f"ð Initializing skill: {skill_name}")
