...
- **Architecture**: Bridge-based (legacy) â New Architecture (JSI, Fabric, Codegen)
...
- **No** â Cross-platform (React Native or Flutter)
- **Yes** â Native (Swift or Kotlin)
...
- **iOS-only** â Swift/SwiftUI
- **Android-only** â Kotlin/Compose
- **Both** â Reconsider cross-platform
