...
âââ reports/
./docs/
âââ system-architecture-blueprint.md (MAINTAIN & UPDATE)
âââ codebase-summary.md (FOLLOW GUIDELINES)
âââ DevPocket\_ Full Project Implementation Plan & Code Standards.md (MAINTAIN & UPDATE)
